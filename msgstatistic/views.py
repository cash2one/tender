...
def add(request):
    if request.POST:
        ...
        return render_to_response('msgstatistic/add.html', context_instance=RequestContext(request))
...
def edit(request, id):
    ...
    return render_to_response('msgstatistic/edit.html', {'msgstatistic': msgstatistic}, context_instance=RequestContext(request))
    ...
    if request.POST:
        ...
        if request.FILES:     
            ...
            for row_index in range(2, sheet.nrows):
                ...
                company_name = sheet.cell_value(row_index, 1)
#                print company_name.__class__ # 查看数据类型,输出结果：<type 'unicode'>
                ...
                address = sheet.cell_value(row_index, 6)
