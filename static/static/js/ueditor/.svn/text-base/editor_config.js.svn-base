...
*/
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //,toolbars:[["bold","italic","underline","strikethrough","forecolor","backcolor","fontfamily","fontsize","justifyleft","justifycenter","justifyright"]]
        ,toolbars:[["bold","italic","underline","strikethrough","forecolor","backcolor","fontfamily","fontsize","justifyleft","justifycenter","justifyright","pasteplain"]]
    ...
    //,lang:'zh-cn'
        ...
        // very import
        ,initialStyle:'body{font-family:"宋体"; font-size: 14px;}'   //编辑器内部样式,可以用来改变字体等
